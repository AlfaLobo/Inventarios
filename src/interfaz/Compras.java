...
public class Compras {
    ...
    public Compras(JFrame f, Usuario u){
        ...
        JPanelNewPurchase.setLayout(new BoxLayout(JPanelNewPurchase, BoxLayout.Y_AXIS));
        ...
        JPanelNewPurchase.add(JLabelProvider);
        JPanelNewPurchase.add(JComboBoxProviders);
        JPanelNewPurchase.add(JLabelProduct);
        JPanelNewPurchase.add(JComboBoxProducts);
        JPanelNewPurchase.add(JLabelQuantity);
        JPanelNewPurchase.add(JTextFieldQuantity);
        JPanelNewPurchase.add(JLabelTotal);
        JPanelNewPurchase.add(JTextFieldTotal);
        JPanelNewPurchase.add(JCheckBoxExpiration);
        JPanelNewPurchase.add(JComboBoxDay);
        JPanelNewPurchase.add(JComboBoxMonth);
        JPanelNewPurchase.add(JComboBoxYear);
        JPanelNewPurchase.add(JButtonAdd);
        JPanelNewPurchase.add(JScrollPanePurchases);
        JPanelNewPurchase.add(JButtonRegister);
        JPanelNewPurchase.setPreferredSize(new Dimension(200, 500));
        c.weightx = 0.5;
